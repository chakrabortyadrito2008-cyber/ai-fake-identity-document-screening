...
def test_ocr_runs_all_configured_variants(monkeypatch):
    ...
    context=SimpleNamespace(preprocessed=np.zeros((100,100,3),dtype=np.uint8),config={"features":{"ocr":True},"ocr":{"languages":"eng","psm":[6,11]},"processing":{"max_ocr_variants":2}},submission={},metadata={})
